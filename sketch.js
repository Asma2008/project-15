...
function draw() {
 ...
 //conditions to check what kind of game state is active
 if(gamestate == "pre-start"){
  fill("white");
textSize(15);
 text("click to start the game",130,290)
 }
else if(gamestate == "end"){
 red_balloonImage.remove();
 textSize(15);
 text("GAME OVER, PRESS R TO RESTART",80,275)
}
